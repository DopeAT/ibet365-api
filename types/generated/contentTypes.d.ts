...
export interface ApiBetCategoryBetCategory extends Struct.CollectionTypeSchema {
...
export interface ApiChallengeChallenge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.String;
    title: Schema.Attribute.String;
    totalBets: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTipSelectionTipSelection
  extends Struct.CollectionTypeSchema {
  collectionName: 'tip_selections';
  info: {
    displayName: 'TipSelection';
    pluralName: 'tip-selections';
    singularName: 'tip-selection';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTipTip extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tipSelections: Schema.Attribute.Relation<
      'oneToMany',
      'api::tip-selection.tip-selection'
    >;
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::bet-category.bet-category': ApiBetCategoryBetCategory;
